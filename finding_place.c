...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/01/22 21:32:26 by gmelissi          #+#    #+#             */
/*   Updated: 2022/01/22 21:32:27 by gmelissi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

//	ft_help_finding_place - поиск наилучшей позиции для вставки.
...
//	ft_finding_place - После нахождения места вставки записывает данные 
//	в steps, которая отправится в ft_instruction_execution.
...
//	ft_smaller_element_detection - Сравнивает найденное место с другими 
...
//	ft_count_to_min - Возвращает положение минимального элемента(числа) в стеке.
